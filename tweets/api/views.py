...
def tweet_list_view(request, *args, **kwargs):
    ...
    return get_paginated_tweetqueryset_response(queryset, request)


def get_paginated_tweetqueryset_response(queryset, request):
    paginator = PageNumberPagination()
    paginator.page_size = 20
    paginated_queryset = paginator.paginate_queryset(queryset, request)
    serializer = TweetSerializer(paginated_queryset, many=True, context={"request": request})
